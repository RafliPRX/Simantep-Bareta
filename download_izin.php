<?php
    ...
    // $pdf->Cell(15,5,'',0,1,'C');
    $print = "SELECT a.id_surat, a.nama, a.nrk, b.nama_jabatan, alamat, a.izin, a.izin_date, a.izin_date_fin FROM surat a, jabatan b WHERE a.id_jabatan=b.id_jabatan AND a.id_surat='$id'";
    ...
    $pdf->Cell(10,7,'',0,0);
    $pdf->Cell(180,7,'Selama '.$row['izin'].' hari kerja, terhitung mulai tanggal '.$row['izin_date'].' dengan ketentuan sebagai berikut :',0,1);
