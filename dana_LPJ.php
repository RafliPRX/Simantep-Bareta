          ...
          <div class="card">
           <div class="card-body">
            ...
            <h2 align="center" class="card-title fw-semibold mb-1">Unit</h2>
              <div class="card">
                <div class="card-body">
                  <!--  Unit Sosial -->
                    <div class="mb-3">   
                        <input type="checkbox" class="form-check-input primary" name="unit" id="unit" value="Sosial" onclick="showForm_Kontrak(this)">
                    ...
                    <!--  Unit Medis -->
                    <div class="mb-3">   
                        <input type="checkbox" class="form-check-input primary" name="unit" id="unit" value="Medis" onclick="showForm_Inportant(this)">
                        ...
                        <div id="form-cuti-alasan-penting" style="display: none;">
                          ...
                          <div class="mb-3">
                            ...
                            <input class="form-control" placeholder="Nama Kegiatan" type="text" name="nama_kegiatan" id="nama_kegiatan"> 
                          </div>
                          <div class="mb-3">
                            <label for="Nama" class="form-label">Rencana Pelaksanaan</label>
                            <input class="form-control" type="date" name="when_event" id="when_event"> 
                          </div>
                        </div>
                            <script>
                    ...
                    <!--  Unit Manajemen -->
                    <div class="mb-3">   
                        <input type="checkbox" class="form-check-input primary" name="unit" id="unit" value="Manajemen" onclick="showForm_Izin(this)">
            ...
            <div class="card-body" style="display: flex; justify-content: center;" >
              ...
              <button type="submit" class="btn btn-primary" value="buat surat" id="simpan_proposal" name="simpan_proposal"> <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-send"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 14l11 -11" /><path d="M21 3l-6.5 18a.55 .55 0 0 1 -1 0l-3.5 -7l-7 -3.5a.55 .55 0 0 1 0 -1l18 -6.5" /></svg> Tambahkan</button>
            </div>
           </form>           
          </div>
        </div>
