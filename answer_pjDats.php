        ...
        <div class="container-fluid">
          <div class="card">
           <div class="card-body">
             ...
             <h5 class="card-title fw-semibold mb-4">Jawaban</h5>
              <div class="card">
                <div class="card-body">
                    ...
                    <input class="form-control" type="number" id="jawab" name="jawab" value="<?php echo $brs[20]; ?>">
                    </div>
                </div>
                <div class="card-body">
            ...
            <!--  alasan ditolak -->
              <div class="card-body">
                <h5 class="card-title fw-semibold mb-1">Alasan Menunda</h5>
                  <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                          <label for="Nama" class="form-label">Alasan Menunda :</label>
                          <textarea class="form-control" name="alasan" id="alasan" cols="30" rows="5"></textarea> 
                        </div>
                    </div>
                  </div>
                  <button type="submit" class="btn btn-primary" value="buat surat" name="createPJdats">Jawab</button>
               </div>
           </form>           
          </div>
        </div>
