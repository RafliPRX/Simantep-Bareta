          ...
          <div class="card">
           <div class="card-body">
                  ...
                  <!--  Unit Sosial -->
                    <div class="mb-3">   
                        ...
                        <div id="form-cuti-kontrak" style="display: none;">
                          ...
                          <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="acc521211" id="acc521211">
                          </div>
                          <div class="mb-3">
                    ...
                    <div class="mb-3">   
                        ...
                        <div id="form-cuti-alasan-penting" style="display: none;">
                          ...
                          <div class="mb-3">
                            <label for="Nama" class="form-label">Kebutuhan Akun 521211 </label>
                            <input class="form-control" type="text" name="521211" id="521211"> 
                          </div>
                          <div class="mb-3">
            ...
            <div class="card-body" style="display: flex; justify-content: center;" >
              ...
              <button type="submit" class="btn btn-primary" value="buat surat" id="simpan_pengajuan" name="simpan_pengajuan"> <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-send"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 14l11 -11" /><path d="M21 3l-6.5 18a.55 .55 0 0 1 -1 0l-3.5 -7l-7 -3.5a.55 .55 0 0 1 0 -1l18 -6.5" /></svg> Tambahkan</button>
            </div>
           </form>           
          </div>
        </div>
