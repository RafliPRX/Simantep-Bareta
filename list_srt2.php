...
<body>
    <h2 align="center">Daftar Surat Ijin</h2>
    <h3 align="center"> selamat datang <?php echo $_SESSION['nama'] ?></h3>
    <h3 align="center"><?php echo $_SESSION['nrk'] ?></h3><br>
    <h3 align="center"><?php echo $_GET['id'] ?></h3><br>
    <table border="0">
    <tr>
    ...
    <table border="1" width="60%" align="center">
        ...
        // $query = "SELECT a.nama, b.nama_jabatan, c.no_kelompok FROM user_bnn a, jabatan b, kelompok c WHERE a.id_jabatan = b.id_jabatan AND a.nama = c.nama AND c.no_kelompok = 1";
        ...
        //     echo "<td align ='center'><a href='answer_pjDats.php?id=$brs[0]'>Liat Surat</a></td>";
        //     echo "</tr>";
        // }
        // }
        // $query="SELECT a.id_surat, a.nama, a.keterangan, b.nama_jabatan, a.veri_1, c.no_kelompok FROM surat a, jabatan b, kelompok c WHERE a.id_jabatan=b.id_jabatan and a.nama=c.nama and a.nama='$id'";
        // $hasil=mysqli_query($konek,$query);
        // while ($brs=mysqli_fetch_array($hasil))
        // {
        //     echo "<tr>";
...
<head>
  ...
  <title>List Surat <?php echo $_GET['id'] ?></title>
