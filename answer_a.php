             ...
             <h5 class="card-title fw-semibold mb-4">Jawaban</h5>
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                    <input class="form-control" type="number" id="jawab" name="jawab" value="<?php echo $brs[21]; ?>">
                    </div>
                </div>
                <div class="card-body">
            ...
            <!--  alasan ditolak -->
             <div class="card-body">
                <h5 class="card-title fw-semibold mb-1">Alasan</h5>
                  ...
                  <button type="submit" class="btn btn-primary" value="buat surat" name="post_a">Jawab</button>
               </div>
           </form>           
          </div>
        </div>
