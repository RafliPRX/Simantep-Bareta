      ...
      <div class="container-fluid">
          <div class="card">
           <div class="card-body">
            ...
            <!-- jawab -->
            <?php 
             $jawab_qry = "SELECT veri_1 FROM surat WHERE id_surat = '$id'";
             $res_pj = mysqli_query($konek, $jawab_qry);
             $jawab_pj = mysqli_fetch_array($res_pj);
            ?>
            <div class="card-body">
