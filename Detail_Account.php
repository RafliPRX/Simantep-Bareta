                ...
                <div class="card" >
                    <div class="card-body" >
                        <div class="mb-3" >
                            ...
                            <input class="form-control" type="text" name="nama" id="nama" value="<?php echo $data[1]; ?>" readonly>
                        </div>
                        <div class="mb-3" >
                            <label for="Nama" class="form-label">Status</label><br>
                            <label for="Nama" class="form-label">Mengunci = 1</label><br>
                            <label for="Nama" class="form-label">buka kunci = 2</label>
                            <input class="form-control" type="text" name="status" id="status" value="<?php echo $data[5]; ?>">
                        </div>
                        <div class="mb-3" >
                            <!-- <label for="Nama" class="form-label">id</label> -->
                            <input class="form-control" type="text" name="id" id="id" value="<?php echo $data[0]; ?>" hidden>
                        </div>

                        <button type="submit" name="unlocked" class="btn btn-primary">Submit</button>
                    </div>
                </div>
            </form>
            <?php 
