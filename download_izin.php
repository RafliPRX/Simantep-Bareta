<?php
    ...
    $pdf->Image('tanda_tangan.png', 115, 186, 80);
    $pdf->Cell(25,7,'',0,1);
    $pdf->Cell(25,7,'',0,0);
    $pdf->Cell(25,7,'',0,1);
    $pdf->Cell(25,7,'',0,0);
    ...
    // $pdf->Cell(15,5,'',0,1,'C');
    $print = "SELECT a.id_surat, a.nama, a.nrk, b.nama_jabatan, alamat, a.izin, a.izin_date, a.izin_date_fin, a.date_now FROM surat a, jabatan b WHERE a.id_jabatan=b.id_jabatan AND a.id_surat='$id'";
    $res = mysqli_query($konek, $print);
    $row = mysqli_fetch_array($res);
    $tanggal_awal = $row['izin_date'];
    $tanggal_akhir = $row['izin_date_fin'];
    ...
    $pdf->Cell(150,7,'SURAT KETERANGAN IZIN',0,1,'C');
    ...
    $pdf->Cell(10,7,'',0,0);
    $pdf->Cell(180,7,'Selama '.$row['izin'].' hari kerja, terhitung mulai tanggal '.$awal.' sampai ' .$akhir. ' dengan ketentuan sebagai berikut :',0,1);
    
    $pdf->Cell(10,7,'',0,1);
    $pdf->Cell(10,7,'',0,0);
    $pdf->Cell(6,7,'a.',0,0);
    $pdf->Cell(180,7,'Sebelum menjalankan izin wajib menyerahkan pekerjaanya kepada atasan langsungnya;',0,1);
    $pdf->Cell(10,7,'',0,0);
    $pdf->Cell(6,7,'b.',0,0);
    $pdf->Cell(180,7,'Setelah selesai menjalankan izin wajib melaporkan diri kepada atasan langsungnya dan',0,1);
    $pdf->Cell(10,7,'',0,0);
    $pdf->Cell(6,7,'',0,0);
    $pdf->Cell(180,7,'bekerja kembali sebagaimana biasa;',0,1);
    $pdf->Cell(10,7,'',0,0);
    $pdf->Cell(6,7,'c.',0,0);
    $pdf->Cell(180,7,'Izin hanya diberikan apabila cuti kontrak telah habis dan bersedia dilakukan pemotongan',0,1);
    $pdf->Cell(10,7,'',0,0);
    $pdf->Cell(6,7,'',0,0);
    $pdf->Cell(180,7,'gaji sejumlah hari izin',0,1);
    $pdf->Cell(10,7,'',0,0);
    $pdf->Cell(6,7,'d.',0,0);
