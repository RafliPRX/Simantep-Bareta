<?php
    ...
    $pdf->Image('tanda_tangan.png', 115, 185, 80);
    $pdf->Cell(25,7,'',0,1);
    $pdf->Cell(25,7,'',0,0);
    $pdf->Cell(25,7,'',0,1);
    $pdf->Cell(25,7,'',0,0);
    ...
    $pdf->Cell(150,7,'SURAT IZIN CUTI ALASAN PENTING',0,1,'C');
    ...
    $pdf->Cell(10,7,'',0,0);
    $pdf->Cell(6,7,'a.',0,0);
    $pdf->Cell(180,7,'Sebelum menjalankan cuti alasan penting wajib menyerahkan pekerjaannya kepada ',0,1);
    $pdf->Cell(10,7,'',0,0);
    $pdf->Cell(6,7,'',0,0);
    $pdf->Cell(180,7,'atasan langsungnya;',0,1);
    $pdf->Cell(10,7,'',0,0);
    $pdf->Cell(6,7,'b.',0,0);
    $pdf->Cell(180,7,'Setelah selesai menjalankan cuti alasan penting wajib melaporkan diri kepada atasan',0,1);
    $pdf->Cell(10,7,'',0,0);
    $pdf->Cell(6,7,'',0,0);
    $pdf->Cell(180,7,'langsungnya dan bekerja kembali sebagaimana biasa;',0,1);
    $pdf->Cell(10,7,'',0,0);
    $pdf->Cell(6,7,'c.',0,0);
    $pdf->Cell(180,7,'Selama menjalankan cuti alasan penting wajib menjaga protokol kesehatan.',0,1);
    $pdf->Cell(10,7,'',0,1);
    $pdf->Cell(10,7,'2.',0,0);
    $pdf->Cell(169,7,'Demikian surat keterangan cuti alasan penting ini dibuat untuk dapat dipergunakan',0,1);
    $pdf->Cell(9,7,'',0,0);
    $pdf->Cell(169,7,' sebagaimana mestinya. ',0,1);
    $pdf->Cell(100,7,'',0,1);
    $pdf->Cell(100,7,'',0,1);
    $pdf->Cell(50,7,'',0,0);
    $pdf->Cell(50,7,'',0,0);
